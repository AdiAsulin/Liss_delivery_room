...
namespace Liss_delivery_room
{
    ...
    class Main_ahot : Employee
    {
        public Department.type department;
        protected int[] degreesArray;
        public Main_ahot(int id, string name, double baseSalary, double montlyHours, HashSet<int> degreesArray = null )
        ...
        {
            return Main_ahot.mergeSalaryDegree(this.degreesArray, this.baseSalary);
        }
